...
const roomsArray = [diningRoom, conservatory, kitchen, study, library, billiardRoom, lounge,
ballroom, hall, spa, livingRoom, observatory,
...
function selectRandom(selectedArray) {
    let randomArray = selectedArray[Math.floor(Math.random() * selectedArray.length)];
...
function revealMystery() {
    ...
    let firstNameDef = mysteryResult.suspect.firstName;
    let lastNameDef = mysteryResult.suspect.lastName;
    let weaponDef = mysteryResult.weapon.name;
    let roomDef =  mysteryResult.room.name;
    let finalResult =`${firstNameDef} ${lastNameDef} killed Mr. Boddy using the ${weaponDef} in the ${roomDef}!`
